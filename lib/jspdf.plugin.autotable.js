...
$('#createPDF').click(function(){
    var TABLE_MARGIN_TOP = 51;

var totalPagesExp = "{total_pages_count_string}";
    var pdfsize = 'a4';
    var pdf = new jsPDF('p', 'mm', pdfsize);
    ...
    var pageContent = function (data) {
        ...
        var headerElement = document.getElementById("myTable");
        var headerMarginTop = 41;

        $(".myHeader").each(function () {
            var innerText = $.trim($(this).text());
            pdf.text(innerText, data.settings.margin.left, headerMarginTop);
        });
        ...
        // 210 is the width of the page, 14 is the margin right, 23 is the width of the text in the footer
        pdf.text(str, 210 - 14 - 23, pdf.internal.pageSize.height - 7);
    };
